...
languageTagalog.onclick=()=>{
    ...
    let libro66=['Genesis','Exodo','Levitico','Mgabilang','Deuteronomio','Josue','Mgahukom','Ruth','1samuel','2samuel','1mgahari','2mgahari','1cronica','2cronica','Ezra','Nehemias','Ester','Job','Awit','Kawikaan','Mangangaral','Awitngmgaawit','Isaias','Jeremias','Panaghoy','Ezekiel','Daniel','Hosea','Joel','Amos','Obadias','Jonas','Mikas','Nahum','Habacuc','Sofonias','Hagai','Zacarias','Malakias','Mateo','Marcos','Lucas','Juan','Mga Gawa','Roma','1corinto','2corinto','Galacia','Efeso','Filipos','Colosas','1tesalonica','2tesalonica','1timoteo','2timoteo','Tito','Filemon','Mgahebreo','Santiago','1pedro','2pedro','1juan','2juan','3juan','Judas','Apocalipsis']
    let showComplete=['Genesis','Exodo','Levitico','Mga Bilang','Deuteronomio','Josue','Mga Hukom','Ruth','1 Samuel','2 Samuel','1 Mga Hari','2 Mga Hari','1 Cronica','2 Cronica','Ezra','Nehemias','Ester','Job','Awit','Kawikaan','Mangangaral','Awit ng mga Awit','Isaias','Jeremias','Panaghoy','Ezekiel','Daniel','Hosea','Joel','Amos','Obadias','Jonas','Mikas','Nahum','Habacuc','Sofonias','Hagai','Zacarias','Malakias','Mateo','Marcos','Lucas','Juan','Mga Gawa','Roma','1 Corinto','2 Corinto','Galacia','Efeso','Filipos','Colosas','1 Tesalonica','2 Tesalonica','1 Timoteo','2 Timoteo','Tito','Filemon','Mga Hebreo','Santiago','1 Pedro','2 Pedro','1 Juan','2 Juan','3 Juan','Judas','Apocalipsis']
    let nextBook2 =0
    let scores=0
    let sComplete=0
